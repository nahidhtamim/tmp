...
@section('title')
Our Journey | TMP Manufacturing Ltd
@endsection
    ...
    <div class="container-fluid bg-primary py-5 bg-header">
        <div class="row py-5">
            <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                <h1 class="display-4 text-white animated zoomIn">Our Journey</h1>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="row">
            <div class="col-md-12">
                <div class="timeline-section" style="display:inline-block;width:100%;overflow-y:auto;">
                <ul class="timeline timeline-horizontal">
                    @foreach($timelines as $timeline)
                    <li class="timeline-item">
                        <div class="timeline-badge primary">{{$timeline->serial}}</div>

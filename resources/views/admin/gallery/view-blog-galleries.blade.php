...
<div class="container-fluid pt-4 px-4">
    <div class="row vh-20 bg-light rounded align-items-center justify-content-center mx-0">
        <div class="d-flex align-items-center justify-content-between my-4">
            <h3 class="mb-0">Gallery Images - {{$blog->name}}</h6>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content bg-light">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
                        <select name="blog_gallery_image_cat_id" class="form-select @error('cat_id') is-invalid @enderror" id="blog_gallery_image_cat_id"
                            required>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#blog_gallery_image_cat_id').on('change', function (e) {
            var id = e.target.value;
            $.get('{{ url('getCategoryImage')}}/' + id,
                function (data) {
                    console.log(id);
                    console.log(data);
                    $('#blog_gallery_images').empty();
                    $.each(data, function (index, element) {
                        $('#blog_gallery_images').append("<input type='hidden' name='page_id[]' value='0'><input type='hidden' name='blog_id[]' value='{{$blog->id}}'><input type='hidden' name='service_id[]' value='0'> <li><input type='checkbox' name='image_id[]' value='"+element.id+"' id='myCheckbox"+element.id+"' /><label for='myCheckbox"+element.id+"'><img src='/upload/images/"+element.image+"' /></label></li>");
                    });
                });
        });
    });

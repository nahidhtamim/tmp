...
<div class="container-fluid pt-4 px-4">
    <div class="row vh-20 bg-light rounded align-items-center justify-content-center mx-0">
        <div class="d-flex align-items-center justify-content-between my-4">
            <h3 class="mb-0">Gallery Images - {{$service->name}}</h6>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content bg-light">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
                        <select name="service_gallery_image_cat_id" class="form-select @error('cat_id') is-invalid @enderror" id="service_gallery_image_cat_id"
                            required>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#service_gallery_image_cat_id').on('change', function (e) {
            var id = e.target.value;
            $.get('{{ url('getCategoryImage')}}/' + id,
                function (data) {
                    console.log(id);
                    console.log(data);
                    $('#service_gallery_images').empty();
                    $.each(data, function (index, element) {
                        $('#service_gallery_images').append("<input type='hidden' name='page_id[]' value='0'><input type='hidden' name='blog_id[]' value='0'><input type='hidden' name='service_id[]' value='{{$service->id}}'> <li><input type='checkbox' name='image_id[]' value='"+element.id+"' id='myCheckbox"+element.id+"' /><label for='myCheckbox"+element.id+"'><img src='/upload/images/"+element.image+"' /></label></li>");
                    });
                });
        });
    });

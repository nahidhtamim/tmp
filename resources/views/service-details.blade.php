...
@section('title')
{{$service->name}} | TMP Manufacturing Ltd
@endsection
            ...
            <div class="col-lg-5 m-auto">
                <div class="position-relative h-100">
                    <img class="img-fluid rounded wow zoomIn cover-image" data-wow-delay="0.9s"
                        src="{{ asset('upload/service/'.$service->image)}}"
                        style="object-fit: cover; border-radius: 20px !important; box-shadow: rgba(0, 0, 0, 0.3) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px;">
                </div>
            </div>
...
<!-- Pricing Plan Start -->
<div class="container-fluid py-5 wow fadeInUp other-services" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
            <h1 class="fw-bold text-primary text-uppercase">Other Services</h1>
        </div>
        <div class="row g-5 py-5">
            @foreach($randoms as $random)

            <div class="col-lg-4 wow slideInUp my-4 mx-auto" data-wow-delay="0.6s">
                <div class="bg-white other-service-details rounded"
                    style=" box-shadow: rgba(0, 0, 0, 0.3) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px;">
                    <div class="border-bottom py-4 mb-4 text-center">
                        <h4 class="text-primary">{{$random->name}}</h4>
                    </div>
                    <div class="img-box" style="height: 350px">
                        <img class="img-fluid" src="{{ asset('upload/service/'.$random->image)}}" alt="" width="100%"
                            height="350px">
                    </div>

                    <div class="py-5 px-3 pt-0">
                        <p>{!! substr($random->description_one, 0, 150)."......" !!}</p>
                        <a href="{{url('/our-services/'.$random->slug)}}" class="btn btn-primary py-2 px-4 mt-4">Find
                            Out More</a>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-5 py-5">
            ...
            <div class="col-lg-4 wow slideInUp my-4 mx-auto" data-wow-delay="0.3s" style="height: 100%; ">
                <div class="blog-item bg-light rounded overflow-hidden"
                    style=" box-shadow: rgba(0, 0, 0, 0.3) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px; min-height: 540px;">
                    ...
                    <div class="p-4">
                        ...
                        <a class="text-uppercase" href="{{url('/blog-details/'.$blog->slug)}}">Learn More<i
    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-6 wow slideInUp p-2" data-wow-delay="0.6s">
                <div class="bg-primary rounded h-100 d-flex align-items-center p-4 wow zoomIn" data-wow-delay="0.9s">
                    @if(session('status'))
            ...
            <div class="col-lg-6 wow slideInUp p-2" data-wow-delay="0.6s">
                <div class="image-text-overlay text-top-left"
                    ...
                    <div class="texts">
                        ...
                        <p class="text-dark px-4" style="z-index: 100"><b>Established in 2010 Total Metal Products Ltd
                                (TMP) are a sector leading machine design and tool making company, specialising in
                                stretch bending, roll forming and, welding & assembly jigs.</b></p>
                        <img src="{{ asset('frontend/img/product-cropped.gif')}}" alt="" width="100%">
                        <a href="{{url('/page/Total-Metal-Products')}}"
                            class="btn btn-primary py-md-3 px-md-5 me-3 mx-3 animated slideInLeft">Find Out More</a>
                    </div>

...
@section('title')
Certifications | TMP Manufacturing Ltd
@endsection
    ...
    <div class="container-fluid bg-primary py-5 bg-header">
        <div class="row py-5">
            <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                <h1 class="display-4 text-white animated zoomIn">Certifications</h1>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="section-title position-relative pb-3 mb-5 text-center">
            <h1 class="fw-bold text-primary">Our Certifications</h1>
        </div>
        <div class="row g-5">
            @foreach($certificates as $cer)
            <div class="col-lg-4 mx-auto text-center" style="height:100%">
                <div class="">
                    <img class="card-img-top" src="{{asset('upload/award_certificate/'.$cer->image)}}" alt="Card image cap">
                    <div class="card-body">
                      <h5 class="card-title text-primary">{{$cer->title}}</h5>
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="section-title position-relative pb-3 mb-5 text-center">
            <h1 class="fw-bold text-primary">Our Awards</h1>
        </div>
        <div class="row g-5">
            @foreach($awards as $award)
            <div class="col-lg-4 mx-auto text-center" style="height:100%">
                <div class="">
                    <img class="card-img-top" src="{{asset('upload/award_certificate/'.$award->image)}}" alt="Card image cap">
                    <div class="card-body">

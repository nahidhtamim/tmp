...
<div class="container-fluid position-relative p-0">
    <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0" style="background-color: #8E191C;">
        <a href="{{url('/')}}" class="navbar-brand p-0">
            <div class="row">
                <div class="col-8 m-0 p-0">
                    <img class="navbar-logo" src="{{ asset('frontend/img/log-white.png')}}" alt="" width="" style="padding-right: 10px; border-right:1px solid #fff;"> 
                </div>
                <div class="col-4 m-0 p-0 navbar-texts">
                    <p class="m-0 p-0">Custom</p>
                    <p class="m-0 p-0">Manufacturing</p>
                    <p class="m-0 p-0">Solutions </p>
                </div>
            </div>
        </a>

...
@section('title')
{{$solution->name}} | TMP Manufacturing Ltd
@endsection
    ...
    <div class="container-fluid bg-primary py-5 bg-header">
        <div class="row py-5">
            <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                <h1 class="display-4 text-white animated zoomIn">{{$solution->name}}</h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-10 m-auto">
                <p class="mb-4">{!! $solution->description_one !!}</p>
            </div>
            <div class="col-lg-5 m-auto">
                <div class="position-relative h-100">
                    <img class="img-fluid rounded wow zoomIn cover-image" data-wow-delay="0.9s"
                        src="{{ asset('upload/service/'.$solution->image)}}" style="object-fit: cover; border-radius: 20px !important; box-shadow: rgba(0, 0, 0, 0.3) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px;">
                </div>
            </div>
            @if($solution->description_two != null)
            <div class="col-lg-10 m-auto">
                <p class="mb-4">{!! $solution->description_two !!}</p>
            </div>
            @endif
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row gallery">
            @foreach($galleries as $gallery)
                @if($gallery->service_id == $solution->id)
...
<div class="container-fluid py-5 wow fadeInUp other-services" data-wow-delay="0.1s">
    <div class="container py-5">
        ...
        <div class="row g-0 py-3">
            ...
            <div class="col-lg-4 wow slideInUp my-4 mx-auto" data-wow-delay="0.6s" style="box-shadow: rgba(0, 0, 0, 0.3) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px; min-height: 540px;">
                <div class="bg-white other-service-details rounded">
                    <div class="border-bottom py-4 px-5 mb-4">
                        <h4 class="text-primary mb-1">{{$random->name}}</h4>
                    </div>
                    <div class="p-5 pt-0">
                        <p>{!! substr($random->description_one, 0, 150)."......" !!}</p>
                        <a href="{{url('/turn-key-solutions/'.$random->slug)}}" class="btn btn-primary py-2 px-4 mt-4">Find Out More</a>
                    </div>
                </div>
            </div>
            @endforeach
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        ...
        <div class="row g-5 py-5">
            ...
            <div class="col-lg-4 m-auto wow slideInUp my-2" data-wow-delay="0.3s" style="height: 100%; ">
                <div class="blog-item bg-light rounded overflow-hidden" style=" box-shadow: rgba(0, 0, 0, 0.3) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px;">
                    ...
                    <div class="p-4">
                        ...
                        <p>{!! substr($blog->description_one, 0, 80)."......" !!}</p>
